        ...
        <div className="flex m-auto py-10 justify-center space-x-6">
          <div className="bg-white w-1/6 h-fit drop-shadow rounded-lg">
            ...
            <div className="py-6 px-5">
              <img className="w-32 rounded-full border border-gray-comps m-auto mb-6" src={user.picture}></img>
                ...
                <h1 className="font-semibold bg-gray-comps rounded-md p-2 mt-6">Contact</h1>              
                  <p className="text-sm leading-7"><span className="font-medium">Phone</span> <span className="font-light">{user.phone_number}</span></p>
