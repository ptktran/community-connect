        ...
        <div class="wrapper">
          ...
          <div class="flex flex-wrap justify-center items-center mt-10 h-full">
              <div class="flex flex-col w-1/4">
                  <input class="mb-5 focus:outline-none bg-gray-200 p-3 rounded-lg" type="text" placeholder="Name" required/> 
                  <input class="mb-5 focus:outline-none bg-gray-200 p-3 rounded-lg" type="text" placeholder="Location" required/> 
                  <input class="mb-5 focus:outline-none bg-gray-200 p-3 rounded-lg" type="text" placeholder="Occupation" required/> 
                  <input class="mb-5 focus:outline-none bg-gray-200 p-3 rounded-lg" type="text" placeholder="Age" /> 
