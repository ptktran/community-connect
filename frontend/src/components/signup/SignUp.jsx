        ...
        <div className="wrapper">
          ...
          <div className="flex flex-wrap justify-center items-center mt-10 h-full">
              <div className="flex flex-col w-1/4">
                  ...
                  <input className="mb-5 focus:outline-none bg-gray-200 p-3 rounded-lg" type="text" placeholder="Occupation" onChange={(e) => setOccupation(e.target.value)} required/> 
                  <input className="mb-5 focus:outline-none bg-gray-200 p-3 rounded-lg" type="text" placeholder="Age" onChange={(e) => setAge(e.target.value)}/> 
